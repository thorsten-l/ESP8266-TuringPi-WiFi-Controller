...
const char SETUP_HTML_TEMPLATE[] PROGMEM =
  ...
  "<div class='accordion'>Turing Pi</div>\n"
  "<div class='panel'>\n"
  "<fieldset>\n"
  
  "<div class='accordion'>Ping</div>\n"
  "<div class='panel sub-panel'>\n"
    "<div class=\"pure-control-group\"><label for=\"pid1\">Enabled</label><input id=\"pid1\" type=\"checkbox\" name=\"ping_enabled\" value=\"true\" %ping_enabled%></div>\n"
    "<div class=\"pure-control-group\"><label for=\"pid2\">Interval</label><input id=\"pid2\" type=\"text\" name=\"ping_interval\" maxlength=\"64\" value=\"%ping_interval%\"></div>\n"
    "<div class=\"pure-control-group\"><label for=\"pid3\">IP address slot 1</label><input id=\"pid3\" type=\"text\" name=\"ping_ip_slot1\" maxlength=\"31\" value=\"%ping_ip_slot1%\"></div>\n"
    "<div class=\"pure-control-group\"><label for=\"pid4\">IP address slot 2</label><input id=\"pid4\" type=\"text\" name=\"ping_ip_slot2\" maxlength=\"31\" value=\"%ping_ip_slot2%\"></div>\n"
    "<div class=\"pure-control-group\"><label for=\"pid5\">IP address slot 3</label><input id=\"pid5\" type=\"text\" name=\"ping_ip_slot3\" maxlength=\"31\" value=\"%ping_ip_slot3%\"></div>\n"
    "<div class=\"pure-control-group\"><label for=\"pid6\">IP address slot 4</label><input id=\"pid6\" type=\"text\" name=\"ping_ip_slot4\" maxlength=\"31\" value=\"%ping_ip_slot4%\"></div>\n"
    "<div class=\"pure-control-group\"><label for=\"pid7\">IP address slot 5</label><input id=\"pid7\" type=\"text\" name=\"ping_ip_slot5\" maxlength=\"31\" value=\"%ping_ip_slot5%\"></div>\n"
    "<div class=\"pure-control-group\"><label for=\"pid8\">IP address slot 6</label><input id=\"pid8\" type=\"text\" name=\"ping_ip_slot6\" maxlength=\"31\" value=\"%ping_ip_slot6%\"></div>\n"
    "<div class=\"pure-control-group\"><label for=\"pid9\">IP address slot 7</label><input id=\"pid9\" type=\"text\" name=\"ping_ip_slot7\" maxlength=\"31\" value=\"%ping_ip_slot7%\"></div>\n"
  "</div>\n"
  "</fieldset></div>\n"
